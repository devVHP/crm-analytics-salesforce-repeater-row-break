...
---
##Notes
- The data used in the example is entirely fictitious and generated by AI.

- In the code, the Rank field was used to control ordering and to display the manager’s name only in the first card of each group.
